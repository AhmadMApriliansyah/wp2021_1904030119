    ...
    <div class="col-md-10 p-5 pt-3">
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="jenis_kelamin" value="<?= $camaba['jenis_kelamin'] ?>" placeholder="jenis_kelamin" name="jenis_kelamin" required autocomplete="off">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="sekolah_asal" value="<?= $camaba['sekolah_asal'] ?>" placeholder="sekolah_asal" name="sekolah_asal" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="foto_maba">Foto</label>
          <input type="text" class="form-control" id="foto_maba" value="<?= $camaba['foto_maba'] ?>" placeholder="foto_maba" name="foto_maba" required autocomplete="off">
        </div>
